<div class="likes index">
	...
	<tr>
		...
		<td><?php echo h($like['Like']['value']); ?>&nbsp;</td>
		<td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $like['Like']['id']), array(), __('Are you sure you want to delete # %s?', $like['Like']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
